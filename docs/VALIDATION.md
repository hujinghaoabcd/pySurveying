...
6. Error ellipses use the coordinate covariance matrix and a chi-square confidence scale.
...
- free-network datum-defect checks
- error-ellipse orientation and confidence-level checks against independent software
